export const testimonialsData = [
  {
    ...
    message:
      'A empresa foi extremamente profissional e atenciosa. O serviço de instalação de câmeras de segurança foi impecável, e agora me sinto muito mais seguro em minha casa.',
    author: 'Carlos Gomes',
  ...
  {
    img: '/solutions/solution-9.jpg',
    message:
      'A automação residencial transformou minha casa em um lar inteligente. Estou muito satisfeito com o serviço.',
